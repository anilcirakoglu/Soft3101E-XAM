...
<div class="top">
    <ul>
        ...
        <li><a href="instructor_settings.php"target="_self">Delete Instructor's Lesson </a></li>
        <li><a href="instructor_settings.php"target="_self">Delete Instructor's Exam </a></li>
  ...
  <div class="mid">
    ...
    <form action="delete_Instructor.php" method="POST">             
                ...
                <button>Delete Instructor</button>
</form>
<?php
        }
        }
