...
<nav>
  ...
  <div class="info">
    <?php
     ...
     $results=mysqli_query($conn,"SELECT * FROM 
     delcourse_request_instructor delci
     join course c on delci.courseId=c.courseId
    ...
    <form action="admin_delete_lessonOfInstructor_continue.php" method="POST">             
