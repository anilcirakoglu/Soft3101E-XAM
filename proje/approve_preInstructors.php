...
<nav>
  ...
  <div class="info">
    <?php
     ...
     $results=mysqli_query($conn,"select * from deneme_1.preinstructor");
    ...
    <form action="add_preInstructor.php" method="POST">             
                <input type="hidden" name="PreinstructorId" value="<?php echo $rows['PreinstructorId']?>">
                <button style="margin-bottom:10px">Add Instructor</button>
</form>
<?php
        }
        }
