...
<nav>
   ...
   <div class="menu">
    <a href="instructorPage.phps" target="_self">Logo</a></li>
        ...
        <div class="show_lessons">
            ...
            <?php
              ...
              $result2 = mysqli_query($conn, "select * from course c JOIN exam e on c.courseId = e.courseId where c.instructorId='$id' ");
            ...
            if (isset($row2["examID"])) {
                ...
                echo "<div>";
                ?>
                <form action="see_exam_finishStudent_Instructor.php" method="POST"> 
       <input type="hidden"  name="examID" id="examID" value=<?php echo $row2["examID"]?>>
       <button>Grade exams</button>
       </form>
