...
<head>
    ...
    <link rel="stylesheet" href="soft3101_student_content_settings.css">
</head>
<body>
<div class="settings">
...
<?php
$setting_class=new SettingsStudent();

$settings=$setting_class->get_settings_student($_SESSION['mybook_userid']);
