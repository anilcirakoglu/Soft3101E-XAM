...
$ROWW=false;
if (isset($_GET['id'])){
    $ROWW=$delete_teacher->get_id_teacher_byAdmin($_GET['id']);
  }else {
      $ERROR="No teacher was found!";
  }
if ($_SERVER['REQUEST_METHOD']=="POST") {
    $delete_class=new AdminSet();
    $delete_class->save_delete_teacher_byAdmin($_POST,$ROWW['userid']);
    if ($result == "") {
...
echo"<p id='textbox'>Are you sure want to delete this teacher ?</p>";
