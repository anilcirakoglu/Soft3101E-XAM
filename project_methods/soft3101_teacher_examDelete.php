...
$delete_exam=new examid();
$ERROR="";
$ROW=false;
if (isset($_GET['id'])){
    $ROW=$delete_exam->get_data_exam($_GET['id']);
  }else {
      $ERROR="No exam was found!";
  }
if ($_SERVER['REQUEST_METHOD']=="POST") {
    $delete_class=new AddExam();
    $delete_class->save_delete_exam_byTeacher($_POST,$ROW['examid']);
    $delete_class=new AddExam();
...
echo"<p id='textbox'>Are you sure want to delete this exam ?</p>";
